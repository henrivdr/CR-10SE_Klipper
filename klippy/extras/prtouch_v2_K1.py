...
class PRTouchEndstopWrapper:
    def __init__(self, config):
        ...
        self.tri_z_up_spd       = config.getfloaavg('lift_speed', self.tri_z_down_spd * (1.0 if self.use_adc else 2.0), minval=0.1, maxval=100)
    ...
    def cmd_SAFE_DOWN_Z(self, gcmd):
        ...
        self.step_res, self.pres_res = [], []
        params = self.deal_avgs_prtouch_cmd.send([self.pres_oid, 8])
        self.print_msg('AVGS_RESULT', str(params))
